      ...
      <main id="home" className="bg-image bg-image-cover d-flex flex-column justify-content-center align-items-center">
        <div className="main-items">
          ...
          <div className="main-icons d-flex flex-row justify-content-center align-items-center">
            <a href={`mailto:${app.email}`} className="link-icon" target="_blank" rel="noreferrer">
            ...
            <a href={app.linkedin} className="link-icon" target="_blank" rel="noreferrer">
            ...
            <a href={app.github} className="link-icon" target="_blank" rel="noreferrer">
            ...
            <a href={app.whatsapp} className="link-icon" target="_blank" rel="noreferrer">
          ...
          <div className="align-items main-links">
            <a href="#services" className="btn btn-primary">My Services</a>
            <a href="#services" className="btn btn-secondary">Download CV</a>
          </div>
        </div>
      </main>
    );
